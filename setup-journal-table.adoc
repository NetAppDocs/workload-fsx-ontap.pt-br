...
* Defina a configuração de rede como *Internet* para o ponto de acesso S3. link:edit-s3-access-point.adoc["Editar a configuração de rede para o ponto de acesso S3"].
...
Se alguma das etapas falhar, <<Troubleshoot the infrastructure setup,solucionar problemas de configuração de infraestrutura para a tabela de diário>> ou entre em contato com o suporte da NetApp para obter ajuda.
