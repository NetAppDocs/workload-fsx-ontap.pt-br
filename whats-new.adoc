...
link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["Saiba mais sobre como criar links"^].
...
link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["Aprenda como associar um link ao seu sistema de arquivos no NetApp Workload Factory"^].
...
link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["Conete-se a um sistema de arquivos FSX for ONTAP com um link do Lambda"^]
...
link:https://docs.netapp.com/us-en/workload-fsx-ontap/manage-volume-capacity.html["Ativar volume com crescimento automático"]
...
link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["Crie um link"^]
