...
link:https://docs.netapp.com/us-en/workload-fsx-ontap/create-s3-access-point.html["Crie e anexe um ponto de acesso S3 para um volume no NetApp Workload Factory"]
