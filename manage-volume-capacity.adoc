...
summary: Aprenda a gerenciar a capacidade de volume, incluindo o ajuste manual do tamanho do volume e o uso de volume com crescimento automático no NetApp Workload Factory. 
---
= Gerencie a capacidade de volume no NetApp Workload Factory
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
[role="lead"]
A capacidade do volume deve ser ajustada conforme as necessidades mudam. Você pode ajustar o tamanho do volume manualmente ou ativar o volume com crescimento automático para que o NetApp Workload Factory gerencie a capacidade do volume para você. Verifique o balanceamento da capacidade do volume FlexVol ou FlexGroup e reequilibre a capacidade do volume para distribuir os arquivos uniformemente entre todos os volumes FlexVol em um nó ou entre todos os componentes, de modo que todos os nós participem da carga de trabalho de um único volume FlexGroup.



[[edit-volume-autogrow]]
== Edite o volume com crescimento automático

Ative o volume com crescimento automático para permitir que o NetApp Workload Factory gerencie a capacidade do volume para você. Você pode desativá-lo a qualquer momento.


NOTE: O volume com crescimento automático não é suportado para volumes iSCSI.

.Antes de começar
Para ativar o volume com crescimento automático, você deve associar um link. link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["Aprenda como associar um link existente ou criar e associar um novo link"^]. Após a associação do link, retorne a esta operação.
...
. Selecione o menu de ações para o volume que você deseja modificar.
...
== Ajuste a capacidade de volume manualmente
...
.Antes de começar
Para ajustar a capacidade de volume, você precisa associar um link. link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["Aprenda como associar um link existente ou criar e associar um novo link"^]. Após a associação do link, retorne a esta operação.
...
== Reequilibrar a capacidade de volume para FlexVol e FlexGroup volumes
...
* Para verificar o saldo de um volume, você deve link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["criar e associar um link ou associar um link existente ao sistema de arquivos"^]. Após a associação do link, retorne a esta operação.
...
* Para reequilibrar um volume, você deve link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["criar e associar um link ou associar um link existente ao sistema de arquivos"^]. Após a associação do link, retorne a esta operação.
