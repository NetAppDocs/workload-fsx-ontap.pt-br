...
* Para dividir um volume clonado, você deve associar um link. link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["Aprenda como associar um link existente ou criar e associar um novo link"^]. Após a associação do link, retorne a esta operação.
...
. Selecione o menu de ações do volume com o volume clonado a ser dividido.
