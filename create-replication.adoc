...
Para a migração de máquinas virtuais de armazenamento, conclua a operação de transição imediatamente após criar uma relação de replicação.
...
* link:initialize-replication.html["Inicializar replicação"] para uma nova relação de replicação.
