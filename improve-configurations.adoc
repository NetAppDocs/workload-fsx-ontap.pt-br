...
* Otimização de custos: eficiências de armazenamento, hierarquização de dados, exclusão desnecessária de snapshots e backups, e dispositivos de bloco inativos
