...
* Otimização de custos: eficiências de storage, hierarquização de dados, exclusão de snapshots e backups desnecessários, dispositivos de bloco inativos e capacidade subutilizada de SSD
