...
* Credenciais com permissões de _criação e exclusão de sistema de arquivos_ para criar um sistema de arquivos FSx para ONTAP . link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html["Saiba como conceder permissões a uma conta da AWS"^].
...
. No painel de controle de armazenamento, selecione *Criar sistema de arquivos*.
