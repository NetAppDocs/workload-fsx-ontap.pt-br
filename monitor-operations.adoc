...
summary: Acompanhe as operações de carga de trabalho e monitore o progresso dos trabalhos com o Tracker no NetApp Workload Factory para FSx for ONTAP. 
---
= Monitore as operações do FSx para ONTAP com o Tracker
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
