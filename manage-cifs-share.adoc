...
summary: O gerenciamento do compartilhamento SMB ou CIFS no Workload Factory inclui a criação, a determinação do acesso de usuários e grupos e a exclusão. 
---
= Gerencie o compartilhamento CIFS de um volume no NetApp Workload Factory
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
* Para gerenciar compartilhamentos SMB/CIFS, você deve associar um link. link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["Aprenda como associar um link existente ou criar e associar um novo link"^]. Após a associação do link, retorne a esta operação.
...
. Selecione o menu de ações do volume para o qual você deseja alterar o compartilhamento SMB.
