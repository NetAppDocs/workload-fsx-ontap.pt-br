...
[role="lead"]
Interrompa uma relação de replicação no workload do BlueXP  de fábrica. Quando você interrompe uma relação de replicação, a replicação agendada é atualizada do volume de origem para a pausa do volume de destino. O volume de destino passa de somente leitura para leitura e gravação.
