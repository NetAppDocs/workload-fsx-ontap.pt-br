...
[role="quick-margin-para"]
Escolha olink:https://docs.netapp.com/us-en/workload-setup-admin/operational-modes.html["políticas de permissão"^] Para atender às suas necessidades.

[role="quick-margin-para"]
Caso opte por não conceder permissões, você poderá começar a usar o Workload Factory para FSx for ONTAP para copiar exemplos de código parcialmente concluídos.
