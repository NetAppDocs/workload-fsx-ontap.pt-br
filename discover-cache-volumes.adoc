...
---
= Descubra volumes de cache no NetApp Workload Factory
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
* Você precisa associar um link para descobrir as relações de cache em um sistema de arquivos. link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["Aprenda como associar um link existente ou criar e associar um novo link"^]. Depois que o link for associado, retorne a esta operação.
